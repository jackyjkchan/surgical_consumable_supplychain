...
if __name__ == "__main__":
    ...
    parser.add_argument('-k', dest='setup_cost', type=int, help='setup cost')
    ...
    setup_cost = args.setup_cost if args.setup_cost else 0
    ...
    prefix = "LA_Model_b_{}_k_{}_info_{}".format(backlogging_cost, setup_cost, info)
