...
data = pd.read_csv("publish/case_study/2020-04-13_parametric_case_study_truncated_full_data.csv")
data["cost"] = data["average_inventory_level"] * 365 + data["surgeries_backlogged"] * data["backlogging_cost"]
data["info_horizon"] = data["info_horizon"].apply(lambda x: str(x))
...
summary.to_csv("publish/case_study/2020-04-13_parametric_case_study_truncated_publish_table.csv")